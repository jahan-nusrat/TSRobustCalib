...
ORDERED_CHANNELS = [
    ...
    'EEG A1', 'EEG A2', 'EEG P3', 'EEG P4', 'EEG O1', 'EEG O2',
...
MONTAGES_CHANNELS_IDX = [
    [ORDERED_CHANNELS.index("EEG " + ch) for ch in montage.split("-")]
    for montage in MONTAGES_NAMES
]

MONTAGES_CHANNELS_IDX_REDUCED = [
    [ORDERED_CHANNELS_REDUCED.index("EEG " + ch) for ch in montage.split("-")]
    for montage in MONTAGES_NAMES_REDUCED
]
